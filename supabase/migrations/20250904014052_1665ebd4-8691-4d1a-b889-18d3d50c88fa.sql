-- First, insert the mock experiences into the database
INSERT INTO public.experiences (id, host_id, title, description, location, address, price, duration_hours, max_guests, category_id, image_urls, what_included, what_to_bring, cancellation_policy) VALUES
-- We'll use a placeholder host_id for now - users can update this later when they have accounts
