-- Create a placeholder host profile for the mock experiences
INSERT INTO public.profiles (id, email, first_name, last_name, is_host, bio, location) VALUES
('00000000-0000-0000-0000-000000000000', 'demo.host@livelocal.com', 'Demo', 'Host', true, 'Demo host account for sample experiences', 'Local Community');

-- Now insert the mock experiences
